...
class WP_User_Avatar_Admin {
  ...
  public function wpua_add_default_avatar() {
    ...
    $wpua_list .= '<p id="wpua-edit"><button type="button" class="button" id="wpua-add" name="wpua-add" data-avatar_default="true" data-title="'._('New Avatar').': '._('Default Avatar').'">'.__('New Avatar').'</button>';
