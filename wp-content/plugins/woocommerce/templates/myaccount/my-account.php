...
$profilepic = get_avatar( $userid , 512 );
...
$profiledone = 0;
$profilecomp = array('picture' => 15,'gender' => 5,'askreview' => 15,'bio' => 15,'languages' => 10,'experience' => 10,'travel' => 10,'location' => 10,'age' => 5,'education' => 5 );
						...
						<div class="middle-tabs">
							<div id="tabs1" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
								...
								<div id="tabs1-1">
									<aside class="widget classaside">
										...
										<div class="text-center">
											<a id="ghost-classes" class="ghost button asidepad" href="http://tiptapgo.co/add-class/">Create your first Class</a>
										</div>
										<?php } else { ?>										
								...
								<div id="tabs1-2">
									<aside class="widget classaside">
										<div class="text-center">
											<a href="http://tiptapgo.co/add-class/">You need to create at least one class before asking for reviews</a>
										</div>									
									</aside>
								</div>
								<?php } ?>
									...
									<?php if($totalReviews > 0): ?>
										<aside class="widget">
											...
											<div class="review-body">
												...
												<div class="pull-right" id="intro4">					
