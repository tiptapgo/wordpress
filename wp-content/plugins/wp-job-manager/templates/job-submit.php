...
<div id="tabs">
  ...
  <div id="tabs-3">
		...
		<?php if(is_user_logged_in() && !is_page( 'Edit Classes' )): ?>
			<input type="submit" name="submit_job" class="button" value="Submit Class" />
		<?php endif; ?>			
		<?php if(is_user_logged_in() && is_page( 'Edit Classes' )): ?>
			<input type="submit" name="submit_job" class="button" value="Edit Class" />
		<?php endif; ?>					
