		...
		<?php if ( ! $generate_username_from_email ) : ?>
			...
			<!--	<label><?php// _e( 'Username', 'wp-job-manager' ); ?> <?php //echo apply_filters( 'submit_job_form_required_label', ( ! $account_required ) ? ' <small>' . __( '(optional)', 'wp-job-manager' ) . '</small>' : '' ); ?></label>-->
				...
				<div class="field">
					...
					<input type="hidden" class="input-text" name="create_account_username" id="account_username" value="<?php if ( ! empty( $_POST['create_account_username'] ) ) echo sanitize_text_field( stripslashes( $_POST['create_account_username'] ) ); ?>" />
...
<!--			<label><?php// _e( 'Your email', 'wp-job-manager' ); ?> <?php// echo apply_filters( 'submit_job_form_required_label', ( ! $account_required ) ? ' <small>' . __( '(optional)', 'wp-job-manager' ) . '</small>' : '' ); ?></label>-->
			...
			<div class="field">
				...
				<input type="hidden" class="input-text" name="create_account_email" id="account_email" placeholder="<?php esc_attr_e( 'Enter your Email', 'wp-job-manager' ); ?>" value="<?php if ( ! empty( $_POST['create_account_email'] ) ) echo sanitize_text_field( stripslashes( $_POST['create_account_email'] ) ); ?>" />
