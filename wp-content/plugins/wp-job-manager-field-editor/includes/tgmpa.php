    ...
    class TGM_Plugin_Activation {
        ...
        public function init() {
            ...
            $this->strings = array(
                ...
                'oops'                           => __( 'Something went wrong.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'notice_can_install_required'    => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'notice_can_install_recommended' => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                ...
                'notice_ask_to_update'           => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                ...
                'install_link'                   => _n_noop( 'Begin installing plugin', 'Begin installing plugins', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'activate_link'                  => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'return'                         => __( 'Return to Required Plugins Installer', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'dashboard'                      => __( 'Return to the dashboard', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'plugin_activated'               => __( 'Plugin activated successfully.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'activated_successfully'         => __( 'The following plugin was activated successfully:', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'complete'                       => __( 'All plugins installed and activated successfully. %1$s', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'dismiss'                        => __( 'Dismiss this notice', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
            );
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' == $_GET['tgmpa-install'] ) ) {
                ...
                if ( empty( $complete ) ) {
                    echo '<p>' .  sprintf( $this->strings['complete'], '<a href="' . admin_url() . '" title="' . __( 'Return to the Dashboard', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '">' . __( 'Return to the Dashboard', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</a>' ) . '</p>';
    ...
    class TGMPA_List_Table extends WP_List_Table {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                if ( ! empty( $plugin['source'] ) ) {
                    ...
                    if ( preg_match( '|^http(s)?://|', $plugin['source'] ) ) {
                        $table_data[$i]['source'] = __( 'Private Repository', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                    // The plugin is pre-packaged with the theme.
                    } else {
                        $table_data[$i]['source'] = __( 'Pre-Packaged', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                    }
                }
                // The plugin is from the WordPress repository.
                else {
                    $table_data[$i]['source'] = __( 'WordPress Repository', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                }

                $table_data[$i]['type'] = isset( $plugin['required'] ) && $plugin['required'] ? __( 'Required', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) : __( 'Recommended', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );

                if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {
                    $table_data[$i]['status'] = sprintf( '%1$s', __( 'Not Installed', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) );
                } elseif ( is_plugin_inactive( $plugin['file_path'] ) ) {
                    $table_data[$i]['status'] = sprintf( '%1$s', __( 'Installed But Not Activated', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) );
                }
        ...
        public function column_plugin( $item ) {
            ...
            if ( ! isset( $installed_plugins[$item['file_path']] ) ) {
                $actions = array(
                    'install' => sprintf(
                        '<a href="%1$s" title="' . __( 'Install', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . ' %2$s">' . __( 'Install', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</a>',
                        wp_nonce_url(
                            add_query_arg(
                                array(
            ...
            elseif ( is_plugin_inactive( $item['file_path'] ) ) {
                $actions = array(
                    'activate' => sprintf(
                        '<a href="%1$s" title="' . __( 'Activate', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . ' %2$s">' . __( 'Activate', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</a>',
                        add_query_arg(
                            array(
                                'page'                 => TGM_Plugin_Activation::$instance->menu,
                                'plugin'               => $item['slug'],
        ...
        public function no_items() {
            ...
            printf( __( 'No plugins to install or activate. <a href="%1$s" title="Return to the Dashboard">Return to the Dashboard</a>', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ), admin_url() );
            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
        ...
        public function get_columns() {
            ...
            $columns = array(
                ...
                'plugin' => __( 'Plugin', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'source' => __( 'Source', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'type'   => __( 'Type', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'status' => __( 'Status', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' )
            );
        ...
        public function get_bulk_actions() {
            ...
            $actions = array(
                'tgmpa-bulk-install'  => __( 'Install', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
                'tgmpa-bulk-activate' => __( 'Activate', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ),
            );
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-install' === $this->current_action() ) {
                ...
                if ( empty( $plugin_installs ) ) {
                    echo '<div id="message" class="error"><p>' . __( 'No plugins are available to be installed at this time.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</p></div>';
                    return false;
                }
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( empty( $plugins_to_activate ) ) {
                    echo '<div id="message" class="error"><p>' . __( 'No plugins are available to be activated at this time.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</p></div>';
                    return false;
                }
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( '<div id="message" class="updated"><p>%1$s %2$s.</p></div>', _n( 'The following plugin was activated successfully:', 'The following plugins were activated successfully:', $count, 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ), $imploded );
                }
 ...
 * @since 2.2.0
 */
add_action( 'admin_init', 'tgmpa_load_bulk_installz' );

if ( ! function_exists ('tgmpa_load_bulk_installz')) {
    function tgmpa_load_bulk_installz() {
            ...
            if ( ! class_exists( 'TGM_Bulk_Installer' ) ) {
                ...
                class TGM_Bulk_Installer extends WP_Upgrader {
                    ...
                    public function install_strings() {
                        ...
                        $this->strings['no_package']          = __( 'Install package not available.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['downloading_package'] = __( 'Downloading install package from <span class="code">%s</span>&#8230;', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['unpack_package']      = __( 'Unpacking the package&#8230;', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['installing_package']  = __( 'Installing the plugin&#8230;', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['process_failed']      = __( 'Plugin install failed.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['process_success']     = __( 'Plugin installed successfully.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                    ...
                    public function activate_strings() {
                        ...
                        $this->strings['activation_failed']  = __( 'Plugin activation failed.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        $this->strings['activation_success'] = __( 'Plugin activated successfully.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
            ...
            if ( ! class_exists( 'TGM_Bulk_Installer_Skin' ) ) {
                ...
                class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                    ...
                    public function add_strings() {
                        ...
                        if ( TGM_Plugin_Activation::$instance->is_automatic ) {
                            $this->upgrader->strings['skin_upgrade_start']        = __( 'The installation and activation process is starting. This process may take a while on some hosts, so please be patient.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_update_successful']    = __( '%1$s installed and activated successfully.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</span><span class="hidden">' . __( 'Hide Details', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</span>.</a>';
                            $this->upgrader->strings['skin_upgrade_end']          = __( 'All installations and activations have been completed.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_before_update_header'] = __( 'Installing and Activating Plugin %1$s (%2$d/%3$d)', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        }
                        // Default installation strings.
                        else {
                            $this->upgrader->strings['skin_upgrade_start']        = __( 'The installation process is starting. This process may take a while on some hosts, so please be patient.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_update_failed_error']  = __( 'An error occurred while installing %1$s: <strong>%2$s</strong>.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_update_failed']        = __( 'The installation of %1$s failed.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_update_successful']    = __( '%1$s installed successfully.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</span><span class="hidden">' . __( 'Hide Details', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</span>.</a>';
                            $this->upgrader->strings['skin_upgrade_end']          = __( 'All installations have been completed.', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                            $this->upgrader->strings['skin_before_update_header'] = __( 'Installing Plugin %1$s (%2$d/%3$d)', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' );
                        }
                    ...
                    public function bulk_footer() {
                        ...
                        if ( empty( $complete ) ) {
                            echo '<p>' .  sprintf( TGM_Plugin_Activation::$instance->strings['complete'], '<a href="' . admin_url() . '" title="' . __( 'Return to the Dashboard', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '">' . __( 'Return to the Dashboard', 'wp-job-manager-field-editor', 'wp-job-manager-field-editor' ) . '</a>' ) . '</p>';
                            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
                        }
