					...
					'populate' => array(
						...
						'fields' => array(
							...
							'populate_save'     => array(
								...
								'caption' => __( 'Automatically save value to user\'s meta.', 'wp-job-manager-field-editor' ),
								'type'    => 'checkbox',
								'default' => '1||Enable',
							),
				...
				if( $packages ){
					$this->modal_fields[ 'tabs' ][ 'packages' ] = array(
						...
						'fields' => array(
							...
							'packages_show'    => array(
								'label'   => __( 'Packages', 'wp-job-manager-field-editor' ),
								'caption' => __( 'Select packages you want this field to show for.  Require must be enabled for this to work.', 'wp-job-manager-field-editor' ),
								'type'    => 'checkbox',
								'default' => $packages,
							)
						)
