...
class WP_Job_Manager_Field_Editor_CPT {
	...
	function update_field_post_meta( $post_id ) {
		...
		$skip_update = array('action', 'nonce', 'filter', 'options', 'packages_show', 'paged', 'post_id', 'modal_action');
		$checkboxes = array( 'admin_only', 'multiple', 'required', 'output_show_label', 'populate_enable', 'populate_save', 'option_default', 'option_disabled', 'packages_require');
		...
		// Update Checkbox post meta values
