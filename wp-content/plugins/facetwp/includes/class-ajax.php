...
class FacetWP_Ajax
{
     ...
     * Otherwise, if first pageload and FWP-variables exist, filter the main query
     */
    function intercept_request() {
        ...
        // Store FacetWP-related GET variables (see class-display.php)
        else {
            ...
            // Attempt to apply GET values for the default query
    ...
    function update_query_vars( $query ) {
        ...
        if ( $is_main_query ) {
            ...
            // Render if we haven't preloaded already
            if ( empty( $this->url_vars ) ) {
