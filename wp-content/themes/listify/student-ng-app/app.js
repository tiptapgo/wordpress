...
.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    // url will be nested (/form/q1sub)
    .state('form.q1sub', {
    	url: '/q1sub',
    	templateUrl: $baseurl + '/q1sub.html'
    })    

    // url will be nested (/form/q2)
    .state('form.q2', {
    	url: '/q2',
...
.controller('formController', function($scope, $rootScope, $http) {
    ...
    $scope.formData = {};
    var join = '';
    $scope.$watch("formData.q1sub",function( newValue, oldValue ) {if ( newValue === oldValue ) return;  else jQuery('.next').click();});
