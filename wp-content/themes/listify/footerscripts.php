...
?>
<script>
jQuery.getScript("https://my.hellobar.com/f231c4f1fbe863fcc6d62f10741d3bfbb9f3caf7.js", hellocallback)
function hellocallback(){
	//jQuery('.primary-header').css({"top":"30px"});
	var iframe = jQuery('#hellobar-container');
	jQuery('.hb-arrow', iframe.contents()).click(function(){
		if(jQuery("#pull-down").hasClass('hb-animateIn')){
			//jQuery('.primary-header').css({"top":"30px"});	
		} else if(jQuery("#pull-down").hasClass('hb-animateOut')){
			//jQuery('.primary-header').css({"top":"0"});
		}
	})
}
</script>
