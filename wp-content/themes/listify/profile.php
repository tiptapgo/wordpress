...
if($nick == '' || $userid == ''){
	header("location: http://tiptapgo.co/sign-up/");
	die();
}
							...
							<div id="secondary" class="widget-area col-md-3 col-sm-3 col-xs-12 col-lg-3" role="complementary">
								...
								<aside class="widget aside-fix"> 
									<div class="infbox">
										...
										<p><a style="color: #3396d1" href="http://tiptapgo.co/tutor/<?php echo $nick; ?>" target="_blank" title="">http://tiptapgo.co/tutor/<?php echo $nick; ?></a></p>
									</div>
								</aside>							
							</div>
							<div id="primary" class="container">
										...
										<div id="tabs1" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
											...
											<div id="tabs1-1">
												<div>
													<?php if($listid == 0){  ?>
													<aside class="widget">
														<div><?php echo $name ?> currently has no classes</div>
													</aside>
													<?php } ?>
