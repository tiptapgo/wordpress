...
$con=mysqli_connect("localhost","yoda","starwars","wordpress");
...
$showpost = (get_post_meta($listid,'_claimed',true))?'publish':'pending';
...
if($showpost == 'publish'){
	update_post_meta($dummyid,'_claimed', true);
}
...
if(isset( $_POST[ 'job_hours' ] )){
	update_post_meta( $dummyid, '_job_hours', stripslashes_deep( $_POST[ 'job_hours' ] ) );	
}
...
header("location: http://tiptapgo.co/edit-classes/");
?>