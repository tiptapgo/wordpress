...
function fb_add_custom_user_profile_fields( $user ) {
	...
	<table class="form-table">
		<tr>
			<th>
				<label for="active"><?php _e('activation', 'your_textdomain'); ?>
				</label></th>
				<td>
					<input type="text" name="active" id="active" value="<?php echo esc_attr( get_the_author_meta( 'active', $user->ID ) ); ?>" class="regular-text" /><br />
					<span class="description"><?php _e('', 'your_textdomain'); ?></span>
				</td>
			</tr>
		<tr>
			<th>
				<label for="active"><?php _e('initdata', 'your_textdomain'); ?>
				</label></th>
				<td>
					<input type="text" name="initdata" id="active" value="<?php echo esc_attr( get_the_author_meta( 'initdata', $user->ID ) ); ?>" class="regular-text" /><br />
					<span class="description"><?php _e('', 'your_textdomain'); ?></span>
				</td>
			</tr>
		</table>
