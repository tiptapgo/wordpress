...
if($mobile==''){
	...
	$code = rand(1000, 9999);
	$url = "http://rest.nexmo.com/sms/json?api_key=8fa2959e&api_secret=b6268d96&from=TipTapGo&to=91".$mobile."&text=TipTapGo%20Verification%20Code:%20".$code;
	$ch = curl_init($url);
