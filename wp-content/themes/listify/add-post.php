				...
				<article>
					<div class="content-box-inner">
						<div class="entry-content">
							<aside class="widget">								
								<form action="<?php echo get_template_directory_uri(); ?>/addclass.php" method="post" id="submit-job-form" class="job-manager-form" enctype="multipart/form-data">
									<div id="tabs">
										...
										<div id="tabs-2">
											...
											<fieldset class="fieldset-hourly_rate">
												...
												<div class="field required-field">
													<input type="text" class="input-text" name="hourly_rate" id="hourly_rate" placeholder="Enter the hourly rate you wish to charge (in ₹)" value="" maxlength="5" required="">
												</div>
											</fieldset>
											<div class="row">
										...
										<!--	<fieldset class="fieldset-featured_image">
												...
												<div class="field ">
													...
													<input type="file" class="input-text wp-job-manager-file-upload" data-file_types="jpg|jpeg|gif|png" multiple="" name="featured_image[]" id="featured_image" placeholder="">
													<small class="description">Maximum file size: 8 MB.	</small>
												</div>
											</fieldset>-->
