...
class Listify_WP_Job_Manager_Template extends listify_Integration {
	 ...
	 * @return void
	 */
	public function the_location( $flat = false ) {
	...
	?>
		<div class="job_listing-url">
			<span itemprop="url"><a href="<?php echo $url; ?>" target="_blank"><?php echo esc_attr( $base ); ?></a></span>
		</div>
	<?php
	}
	...
	?>
		<div class="archive-job_listing-filter-title">
			...
			<h3 class="archive-job_listing-found">
				<?php printf( __( '<span class="results-found">%s</span> Results Found', 'listify' ), listify_has_integration( 'facetwp' ) ? do_shortcode( '[facetwp counts="true"]' ) : $wp_query->found_posts ); ?>
			</h3>
		</div>
	<?php
	}
