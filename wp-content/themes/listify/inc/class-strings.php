	...
	private function get_strings() {
		$strings = array(
			'wp-job-manager' => array(
				...
				'Your listings are shown in the table below. Expired listings will be automatically removed after 30 days.' => __( 'Your listings are shown in the table below. Expired listings will be automatically removed after 30 days.', 'listify' ),
				'If you don&rsquo;t have an account you can %screate one below by entering your email address/username. A password will be automatically emailed to you.' => __( 'If you don&rsquo;t have an account you can %screate one below by entering your email address. A password will be automatically emailed to you.', 'listify' ),
