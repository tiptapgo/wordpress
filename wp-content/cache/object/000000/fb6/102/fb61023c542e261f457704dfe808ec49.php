kšU<?php exit; ?>a:1:{s:7:"content";a:1:{s:12:"search-12391";s:7596:"<div class="listify_widget_search_listings"><hgroup class="home-widget-section-title"><h1 class="home-widget-title">Welcome!<h2 class="home-widget-description">TipTapGo Helps You Find Amazing TeachersÂ In Your Area.</h2></h1></hgroup><div class="job_listings" data-location="" data-keywords="" data-show_filters="true" data-show_pagination="true" data-per_page="10" data-orderby="featured" data-order="DESC" data-categories="" >
		...
		<div class="search_location">
			...
			<input type="text" name="search_location" id="search_location" placeholder="Location" value="" />
				...
				<label for="search_categories">Category</label>
									<select name='search_categories[]' id='search_categories' class='job-manager-category-dropdown '  data-placeholder='Choose a category&hellip;'>
<option value="">Any category</option>	<option class="level-0" value="39">Arts</option>
	...
	<option class="level-1" value="118">&nbsp;&nbsp;&nbsp;Public Speaking</option>
			...
			<div class="search-radius-label">
				<label for="use_search_radius">
					...
					Radius: <span class="radi">2</span> km				</label>
			</div>
			<div class="search-radius-slider">
				<div id="search-radius"></div>
			</div>

			<input type="hidden" id="search_radius" name="search_radius" value="2" />
		</div>
	...
	<p class="filter-by-type-label">Filter by type:</p><input type="hidden" id="search_context" name="search_context" value="846" />	<ul class="job_types">
					<li><label for="job_type_conducted-at-students-location" class="conducted-at-students-location"><input type="checkbox" name="filter_job_type[]" value="conducted-at-students-location"  checked='checked' id="job_type_conducted-at-students-location" /> Conducted At Student's Location</label></li>
					<li><label for="job_type_conducted-at-tutors-location" class="conducted-at-tutors-location"><input type="checkbox" name="filter_job_type[]" value="conducted-at-tutors-location"  checked='checked' id="job_type_conducted-at-tutors-location" /> Conducted At Tutor's Location</label></li>
			</ul>
...
<noscript>Your browser does not support JavaScript, or it is disabled. JavaScript must be enabled in order to view listings.</noscript><ul class="job_listings"></ul></div></div>";}}